...
if __name__ == "__main__":
    ...
    try:
        w1 = np.load("/content/best_mambo_weights_w1 (6).npy")
        w2 = np.load("/content/best_mambo_weights_w2 (5).npy")
        discrete_genome = np.load("/content/best_mambo_genome_finetuned (6).npy")
    ...
    np.save("/content/master_mambo_genome_64_neuron_1.npy", master_genome)
    ...
    json_filename = f"/content/mambo_genome_{Config.HIDDEN_SIZE}N_macro{MACRO_SIZE}_stats_1.json"
...
# ==========================================================================
    ...
    json_filename = f"/content/mambo_genome_{Config.HIDDEN_SIZE}N_master_stats_1.json"
    with open(json_filename, "w") as f:
        json.dump(telemetry, f, indent=4)
