# ==============================================================================
# CLEAN MEMBO SNN TRAINING ENGINE (Raw Audio / No Earplugs)
...
print(f"🚀 Clean Membo Training Engine on: {device}")
...
class Config:
    ...
    # POINTING STRICTLY TO STANDARD NOISE (No Hostile Bebop Audio)
...
def compute_fisher_stats(X_train, Y_train):
    print(f"📐 Computing Fisher stats targeting MEMBO frequencies...")
...
if __name__ == "__main__":
    print("\n" + "=" * 80)
    print(f"🚀 CLEAN TRAINING ENGINE: TARGETING MEMBO")
    print("=" * 80)
    ...
    if best_overall is not None:
        ...
        print(f"\n🏁 Best RAW Membo champion safely saved to Google Drive! Deployment Spec -> Recall: {best_macro_rec:.1f}% | FAR: {best_macro_far:.1f}%")