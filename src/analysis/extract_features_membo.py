...
# CONFIGURATION
# ==============================================================================
DRONE_ANALYSIS_ROOT = 'C:/Users/omer-/Desktop/drone_audio_detector/drone_analysis_data/membo_phase'
...
# Handle both naming conventions
    if os.path.exists(os.path.join(subset_path, 'membo')):
        drone_folder = os.path.join(subset_path, 'membo')
    ...
    # Step 1: Compute average membo spectrum and harmonic bands
    print("🔍 Computing average membo spectrum...")
